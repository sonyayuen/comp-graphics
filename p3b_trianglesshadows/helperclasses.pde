...
public class Triangle extends Shape {
  ...
  public Hit intersectRay(Ray ray) 
  {
   ...
   PVector intV1 = PVector.sub(intersection, this.v1);
   PVector intV2 = PVector.sub(intersection, this.v2);
   PVector intV3 = PVector.sub(intersection, this.v3);
    
   PVector v1v2 = PVector.sub(this.v2, this.v1);
   PVector v2v3 = PVector.sub(this.v3, this.v2);
   PVector v3v1 = PVector.sub(this.v1, this.v3);
    
   PVector triple1 = intV1.cross(v1v2);
   PVector triple2 = intV2.cross(v2v3);
   PVector triple3 = intV3.cross(v3v1);
   
   float triple10 = PVector.dot(triple1, this.normal);
   float triple20 = PVector.dot(triple2, this.normal);
   float triple30 = PVector.dot(triple3, this.normal);
  ...
  // ===== (TODO) Stage 1 ends =======
    if ( ((triple10 >= 0) && (triple20 >= 0) && (triple30 >= 0)) || ((triple10 < 0) && (triple20 < 0) && (triple30 < 0)) ){
